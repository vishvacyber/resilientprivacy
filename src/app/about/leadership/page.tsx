          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {leadership
              ...
              .map((leader) => (
                <div
                  key={leader.name}
                  className="group bg-background-card rounded-xl p-6 border border-border-light/20 hover:border-primary-500/30 transition-all duration-300 cursor-pointer hover:shadow-lg hover:shadow-primary-500/10 hover:-translate-y-1"
                  onClick={() =>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              <div
                key={advisor.id}
                className="group bg-background-card rounded-xl p-6 border border-border-light/20 hover:border-primary-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-primary-500/10 hover:-translate-y-1"
              >
