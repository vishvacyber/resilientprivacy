...
export default function CareersPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="relative py-20 sm:py-24 lg:py-32 px-4 sm:px-6 overflow-hidden bg-gradient-to-br from-background to-background-alt">
      ...
      <section
        id="positions"
        className="relative py-24 sm:py-32 lg:py-40 px-4 sm:px-6 bg-background"
      >
        <div className="max-w-7xl mx-auto relative z-10">
          {/* Header */}
          <div className="text-center mb-20">
            <div className="inline-flex items-center gap-2 bg-primary-500/10 backdrop-blur-sm border border-primary-500/20 rounded-full px-4 py-2 mb-8">
            ...
            <h2 className="text-5xl sm:text-6xl lg:text-7xl font-light text-white mb-8 tracking-tight">
              Join Our
              <span className="block font-bold darkfire-text-gradient">
                Leadership Team
              </span>
            </h2>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-background-card rounded-3xl overflow-hidden shadow-purple border border-border-light/20">
              {/* Executive Header */}
              ...
              <div className="p-8 sm:p-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                  <div className="text-center group">
                    <div className="w-16 h-16 bg-background-alt border border-border-light/20 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:bg-primary-500/10 group-hover:border-primary-500/30 transition-all duration-300">
                ...
                <div className="text-center mb-8">
                  <Link
                    ...
                    className="group inline-flex items-center gap-3 bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
                  >
                ...
                <div className="text-center">
                  ...
                  <p className="text-lg text-text-secondary">
                    ...
                    <a
                      ...
                      className="text-primary-500 hover:text-white underline font-semibold"
                    >
