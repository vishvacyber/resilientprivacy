        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap gap-4">
            <div className="bg-[#1A1A1A] px-4 py-2 rounded-lg border border-[#333]">
              <span className="text-[#8B5CF6] font-semibold">GDPR</span>
              <span className="text-[#A1A1AA] ml-2">Compliant</span>
            </div>
            <div className="bg-[#1A1A1A] px-4 py-2 rounded-lg border border-[#333]">
              <span className="text-[#8B5CF6] font-semibold">
                Effective Date
              </span>
              <span className="text-[#A1A1AA] ml-2">January 1, 2025</span>
            </div>
            <div className="bg-[#1A1A1A] px-4 py-2 rounded-lg border border-[#333]">
              <span className="text-[#8B5CF6] font-semibold">Version</span>
              <span className="text-[#A1A1AA] ml-2">2.1</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="bg-[#1A1A1A] p-8 rounded-xl border border-[#333]">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-[#0D0D0F] rounded-lg">
                ...
                <div className="text-sm text-[#A1A1AA]">GDPR Compliant</div>
              </div>
              <div className="text-center p-4 bg-[#0D0D0F] rounded-lg">
                <div className="text-2xl font-bold text-[#8B5CF6] mb-2">
                  24/7
                </div>
                <div className="text-sm text-[#A1A1AA]">Data Protection</div>
              </div>
              <div className="text-center p-4 bg-[#0D0D0F] rounded-lg">
                <div className="text-2xl font-bold text-[#8B5CF6] mb-2">
                  72h
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-4">
                    <div className="bg-[#8B5CF6] text-white rounded-full w-6 h-6 flex items-center justify-center font-bold text-xs">
                      1
                    </div>
                    <div>
                      <div className="font-semibold text-white">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              ...
              className="btn bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#8B5CF6] text-lg px-8 py-4"
            >
              View Privacy Policy
            </Link>
          </div>
